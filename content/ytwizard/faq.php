				...
				<div class="content_wrapper clearfix">
					<div class="sections_group">
						<div class="entry-content" >
							<div class="section " style="padding-top:22px; padding-bottom:0px; background-color:#FFF;">
							...
							<div class="section " style="padding-top:0px; padding-bottom:10px; background-color:#FFF; ">
								<div class="section_wrapper clearfix">
									<div class="items_group clearfix">
										<!-- One Third (1/3) Column -->
			<div class="column one column_faq">
											<div class="faq">
												<div class="mfn-acc faq_wrapper open1st">
													<div class="question">
														<div class="title">
															<span class="num">1</span><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>Do you accept all Youtube channels ?
														</div>
														<div class="answer">
															Actually we accept all phone verified youtube channels.
														</div>
													</div>
													<div class="question">
														<div class="title">
															<span class="num">2</span><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>What are available video categories ?
														</div>
														<div class="answer">
															Currently we have only educational content including IT development, design, marketing... Sports vdeios will be disponible soon. Check how it works section to see all available categories. 
														</div>
													</div>
													<div class="question">
														<div class="title">
															<span class="num">3</span><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>What 's the pricing for this service?
														</div>
														<div class="answer">
															Our service 100% FREE with no hidden fees, and will stay FREE forever.
														</div>
													</div>
													<div class="question">
														<div class="title">
															<span class="num">4</span><i class="icon-plus acc-icon-plus"></i><i class="icon-minus acc-icon-minus"></i>How to stop getting new videos ?
														</div>
														<div class="answer">
															Contact us via contact form and we will stop sending new videos wthin 24h.
														</div>
													</div>
												</div>
											</div>
